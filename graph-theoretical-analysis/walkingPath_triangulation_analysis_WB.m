...
savepath= '...\Analysis\walkingPaths_triangulation\';

savepathWPD = '...\Analysis\walkingPaths_triangulation\walkingPathDensity\';
...
landmarkspath = '...\Analysis\NodeDegreeCentrality\';

% location of file containing all gaze data and all interpolated of all participants
cd '...\Pre-processsing_pipeline\interpolatedColliders\'

pathAllParts = '...\Analysis\allParticipants\';
